...
util.DateTime.prototype = {
  ...
  toString: function(fmt) {
    ...
    r = r.replace(/%t/g, this.timestamp + '');
    return r;
  }
};
...
util.xlscolN2A = function(n) {
  return ((n > 0) ? util.strp(util.A2Z, n) : '');
};
 ...
 * ['A', 'B', 'C', 'B', 'A', 'A'] -> ['A', 'B', 'C']
 */
util.toUnique = function(arr, srt) {
...
util.infotip.isVisible = function() {
  return util.infotip.obj.el.body != null;
};
...
util.Window.prototype = {
  ...
  endMove: function(ctx) {
    ...
    util.callFn(ctx.opt.onstopmove, ctx, x, y);
  },
  resetSize: function() {
...
util.dialog = function(content, opt) {
  ...
  ctx.modal = util.modal.show(ctx.el, closeAnywhere, onclose);
...
util.dialog.prototype = {
  create: function(ctx, body, opt) {
    ...
    if (opt && opt.className) base.className += ' ' + opt.className;
  ...
  createDialogBody: function(ctx, content, opt) {
    ...
    if (buttons) {
      for (var i = 0; i < buttons.length; i++) {
        ...
        style = {'margin-top': '1em', 'margin-bottom': '0.3em'};
...
util.Counter = function(el, opt) {
  ...
  var v = util.trunc(parseFloat(opt.value), opt.scale);
...
util.Counter.prototype = {
  ...
  setValue: function(v, dur) {
    var ctx = this;
    v = util.trunc(parseFloat(v), ctx.scale);
    ctx._stopTmr(ctx);
    ctx.v = v;
