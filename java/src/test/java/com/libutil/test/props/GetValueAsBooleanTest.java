...
public class GetValueAsBooleanTest {
  ...
  public static void test1t(Props props) {
    for (int i = 1; i <= 8; i++) {
      String key = "key" + i + "t";
      boolean value = props.getValueAsBoolean(key);
      Log.i(key + "=" + value);
    }
  }
  ...
  public static void test2t(Props props) {
    for (int i = 1; i <= 8; i++) {
      String key = "key" + i + "t";
      boolean value = props.getValueAsBoolean(key, "1");
      Log.i(key + "=" + value);
    }
  }
  ...
  public static void test3t(Props props) {
    ...
    for (int i = 1; i <= 8; i++) {
      String key = "key" + i + "t";
      boolean value = props.getValueAsBoolean(key, tvalues);
      Log.i(key + "=" + value);
    }
  }
